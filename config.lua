...
lvim.builtin.which_key.mappings["e"] = { "<cmd>NeoTreeShowToggle<CR>", "Explorer" }
lvim.keys.term_mode["<C-h>"] = false
lvim.keys.term_mode["<C-j>"] = false
lvim.keys.term_mode["<C-k>"] = false
lvim.keys.term_mode["<C-l>"] = false
lvim.keys.normal_mode["<D-r>"] = false;
lvim.keys.normal_mode["<D-R>"] = false;
lvim.keys.normal_mode["<C-o>"] = ":RustRun<CR>"

-- START Rust keybindings
